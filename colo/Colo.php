<?php
/**
 * The Colo class is a static representation of the framework.
 *
 * Core.
 ...
 * @method  static \colo\template\View view() Returns View instance.
 *
 * Request & Response.
...
class Colo {
    ...
    public static function __callStatic($name, $params) {
        ...
        return \colo\core\Dispatcher::invokeMethod(array($app, $name), $params);
    }

    /**
     * @return \colo\Engine Application instance
     */
