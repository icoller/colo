...
class Request {
    ...
    /**
     * @var \colo\util\Collection Query string parameters
     */
    public $query;

    /**
     * @var \colo\util\Collection Post parameters
     */
    public $data;

    /**
     * @var \colo\util\Collection Cookie parameters
     */
    public $cookies;

    /**
     * @var \colo\util\Collection Uploaded files
     */
    public $files;
